				...
				<div class="col-12 col-md-6 mb-4">
                    <div class="row">
                        ...
                        <div class="col pl-0">
							...
							<button type="button" onclick="whats('<? echo str_replace("(","", str_replace(")","", str_replace("-","",$row['celular'])));?>');" class="mb-2 btn btn-outline-success  rounded-0">Whats <i class="fa fa-whatsapp" aria-hidden="true"></i></button>
