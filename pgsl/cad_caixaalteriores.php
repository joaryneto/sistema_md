            ...
            <div class="row" id="load">
								...
								<div class="form-group col-md-12 m-t-20" style="clear: both;">
                                        <table class="table table-hover">
										  ...
										  ?>
                                            <tr onclick="requestPage2('?br=rel_caixaanteriores&codigo=<? echo $row['codigo'];?>','loadanteriores','GET');" data-toggle="modal" data-target="#extratocaixaanteriores" aria-invalid="false"><!-- color: #20aee3; -->
