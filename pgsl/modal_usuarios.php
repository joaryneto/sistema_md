...
<!-- Modal -->
			...
			<div class="form-group col-md-6 m-t-20"><label>Serviço :</label>
                ...
                <option value="">Selecionar Serviço</option>
				 <?
				 $SQL2 = "SELECT produtos.codigo, produtos.descricao, produtos.descricao from produtos where sistema='".$_SESSION['usuario']."' and produtos.tipo=2 order by produtos.descricao ASC";
