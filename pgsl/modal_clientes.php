...
<input name="user" type="text" class="form-control" autocomplete="off" onkeyup="javascript: requestPage2('?br=atu_listacliente&pesquisa='+ this.value +'&ap=1','listusuarios','GET');" />
</div>
<div id="listusuarios">
...
{
?>
<tr style="cursor: pointer;" onMouseOver="this.style.color='#C0C0C0'" onMouseOut="this.style.color='#67757c'" onclick="SL_cliente('<? echo $row['codigo'];?>','<? echo $row['nome'];?>');">
