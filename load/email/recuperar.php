              ...
              <tr>
                <td class="wrapper" style="background: grey;border-color: blue;border: 5ox;border-radius: 20px;">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="background: white;padding: 20px;">
                    <tr>
					<td><img src="http://sl.ectecnologia.com.br/template/images/logo.png" height="120px"/></td>
					</tr>
					<tr>
                      <td>
					  <br /><br />
                            ...
                            <tr>
                              <td align="left">
                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td><a href="https://sl.ectecnologia.com.br/" style="width: 180px; color: black;background: #038fce;" target="_blank">Link de Acesso</a>
									  </td>
									  </tr>
                                  </tbody>
                                </table>
                        ...
                        <p>Atenciosamente,<br /> EC Tecnologia</p>
                      </td>
                    </tr>
                  </table>
                </td>
