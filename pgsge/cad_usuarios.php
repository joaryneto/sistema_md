  ...
  <div class="row">
	<div class="col-md-12 col-sm-12"> 
		<div class="component-box">
								...
								<input type="text" name="cpf" id="cpf" <? if(isset($_GET['codigo'])){ ?> value="<? echo $cpf; ?>" readonly <? } ?> class="form-control" onclick="requestPage2('?br=modal_usuarios&codigo=<?=$_GET['codigo'];?>&modal=1','modals','GET');" data-toggle="modal" data-target="#modalusuario" required="required"></div>
								...
								<? if(!Empty($_GET['codigo'])){?>
								<button type="button" class="btn btn-info" onclick="requestPage2('?br=modal_usuarios&codigo=<?=$_GET['codigo'];?>&modal=2','modals','GET');" data-toggle="modal" data-target="#modalusuario"><i class="fa fa-plus-circle"></i> Turmas </button>
