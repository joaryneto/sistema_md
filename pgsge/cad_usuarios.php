		...
		<div class="component-box">
			...
			$('.sh-usuarios').on('click',function()
			{
			   ...
			   requestPage2('?br=modal_usuarios&modal=1','modals','GET');
								...
								<button type="button" style="position: absolute;left: 80%;top: 31px;height: 55px;width: 50px;" onclick="requestPage2('?br=modal_usuarios&amp;codigo=&amp;modal=1','modals','GET');" class="btn btn-info" data-toggle="modal" data-target="#modalap">
